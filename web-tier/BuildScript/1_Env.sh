...
export ENV="prod"
export GITLAB_PROJECT_ID="44038877"
export GITLAB_PROJECT_NAME="1_web-tier"
export GITLAB_PROJECT_PATH="anirban-grp/aws-project/aws-three-tier-web-architecture/web-tier"
export GITLAB_PROJECT_URL="https://gitlab.com/anirban-grp/aws-project/aws-three-tier-web-architecture/web-tier"
