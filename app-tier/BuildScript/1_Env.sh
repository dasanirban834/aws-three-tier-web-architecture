...
export ENV="prod"
export GITLAB_PROJECT_ID="44038885"
export GITLAB_PROJECT_NAME="2_app-tier"
export GITLAB_PROJECT_PATH="anirban-grp/aws-project/aws-three-tier-web-architecture/app-tier"
export GITLAB_PROJECT_URL="https://gitlab.com/anirban-grp/aws-project/aws-three-tier-web-architecture/app-tier"
