...
resource "aws_instance" "instance" {
  ...
  subnet_id                   = (each.value.availability_zone == "us-east-1a" ? data.aws_subnet.app_subnet_1a.id : (each.value.availability_zone == "us-east-1b" ? data.aws_subnet.app_subnet_1b.id : "0"))
